...
| 7 · Extensions | planned — see `PLAN.md`. Colombia export availability via XM's open API is now the highest-value item on it: the import ceiling is the adequacy model's most fragile term, and XM publishes the other side of it |
