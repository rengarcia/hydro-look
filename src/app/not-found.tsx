        ...
        <section className="shell detail-hero not-found" aria-labelledby="nf-title">
          <div className="hero-copy">
            ...
            <p className="hero-lede">
              Puede que el enlace esté mal escrito, o que lleve a un día o a un embalse que este sitio no tiene. Los datos de hoy están en
              la portada, y lo publicado cada día, en el archivo.
            </p>
