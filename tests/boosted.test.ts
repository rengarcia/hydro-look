...
describe("M4 feature rows", () => {
  ...
  it("are the same whether the series stops at t or a year later — no look-ahead", () => {
...
describe("boostedModel", () => {
  ...
  it("gives the same forecast from a fresh cache as from a warm one, every time", () => {
  ...
  it("returns ordered quantiles on the requested horizons", () => {
